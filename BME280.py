...
class BME280(object):
    def __init__(self, mode=BME280_OSAMPLE_1, addr=0x76):
        ...
        self._addr.writeByte(self._addr, BME280_REGISTER_CONTROL, 0x3F)
        self.t_fine =0.0
    ...
    def read_pressure(self):
        ...
        var1 = ((dig_P3) * var1 * var1 / 524288.0 + ( self.dig_P2) * var1) / 524288.0
    ...
    def read_humidity(self):
        ...
        var_H = (adc - (self.dig_H4 * 64.0 + self.dig_H5 / 16384.0 * var_H)) * (self.dig_H2 / 65536.0 * (1.0 + self.dig_H6 / 67108864.0 * var_H * (1.0 + self.dig_H3 / 67108864.0 * self.var_H)))
